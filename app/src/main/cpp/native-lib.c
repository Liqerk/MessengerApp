...
Java_com_example_myapplication_dpi_core_ByeDpiProxy_jniCreateSocketWithCommandLine(
        JNIEnv *env,
...
JNIEXPORT jint JNICALL
Java_com_example_myapplication_dpi_core_ByeDpiProxy_jniCreateSocket(
        JNIEnv *env,
        __attribute__((unused)) jobject thiz,
        jstring ip,
        jint port,
...
JNIEXPORT jint JNICALL
Java_com_example_myapplication_dpi_core_ByeDpiProxy_jniStartProxy(
...
JNIEXPORT jint JNICALL
Java_com_example_myapplication_dpi_core_ByeDpiProxy_jniStopProxy(
        __attribute__((unused)) JNIEnv *env,
        __attribute__((unused)) jobject thiz,
        jint fd) {
