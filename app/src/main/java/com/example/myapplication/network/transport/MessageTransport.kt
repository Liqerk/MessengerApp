...
interface MessageTransport {
    ...
    // Возвращаем Int
    suspend fun sendMessage(sender: String, receiver: String, text: String): TransportResult<Int>
    suspend fun sendMediaMessage(sender: String, receiver: String, text: String, type: String, mediaUrl: String, duration: Int): TransportResult<Int>
    ...
    suspend fun uploadFile(file: java.io.File): TransportResult<String>
